...
//      TELEMETRY
        ...
        telemetry.addData("Red", robot.sensorColorR.blue());
        telemetry.addData("Green", robot.sensorColorR.green());
        telemetry.addData("Blue", robot.sensorColorR.blue());
